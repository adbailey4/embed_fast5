...
macro(add_gtest TESTNAME)
    ...
    if(GOOGLE_TEST_INDIVIDUAL)
        message(GOOGLE_TEST_INDIVIDUAL)
        message(CMAKE_VERSION VERSION_LESS 3.10: ${CMAKE_VERSION})
...
#            set_tests_properties(${TmpTestList} PROPERTIES FOLDER "Tests")
        ...
        message(NOT GOOGLE_TEST_INDIVIDUAL)
        add_test(${TESTNAME} COMMAND ${TESTNAME} ${ARGN})
