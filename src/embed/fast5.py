...
class Fast5(h5py.File):
    ...
    def get_basecall_data(self, section=__default_section__, analysis=__default_basecall_1d_analysis__):
        ...
        try:
            ...
            raise IndexError('Could not retrieve basecall_1D data from {}'.format(events_path))
    ...
    def get_fastq(self, analysis=__default_basecall_1d_analysis__, section=__template_section__, custom=None):
